...
const faqData = [
  ...
  // ... (sisa data FAQ tidak berubah)
  {
    ...
    answer: 'Kitversity menerapkan sistem pembelian langsung (ready stock) untuk produk yang tersedia. Tim kami akan selalu update mengenai berbagai informasi pada grup whatsapp para pembeli.'
  },
  {
    id: '6',
    category: 'shipping',
