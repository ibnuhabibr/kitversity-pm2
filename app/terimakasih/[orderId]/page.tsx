...
export default function ThankYouPage() {
    ...
    const handleConfirmPayment = () => {
        if (!order) {
             toast({
                title: "Error",
                description: "Data pesanan belum termuat, tidak bisa membuat pesan.",
                variant: "destructive",
            });
            return;
        }
...
Terima kasih!`;
            ...
            toast({
                title: "Oops! Terjadi Error",
                description: "Tidak dapat membuat pesan otomatis. Silakan hubungi admin secara manual.",
                variant: "destructive",
            });
        }
    };
...
// Menambahkan ini di akhir file untuk mengatasi error "is not a module"
export {};